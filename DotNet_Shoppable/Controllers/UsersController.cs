...
namespace DotNet_Shoppable.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            IQueryable<ApplicationUser> query = userManager.Users.OrderByDescending(userManager => userManager.CreatedAt);
        ...
        public async Task<IActionResult> Details(string? id)
        {
            ...
            // get available roles defined in DatabaseInitializer
        ...
        public async Task<IActionResult> EditRole(string? id, string? newRole)
        {
            ...
            {
                TempData["ErrorMessage"] = "You cannot update your own role!"; // TempData can be used to display messages in another view
